...
projectRouter.get("/:projectId", checkAuth, routeWrapper(projectHandlers.getProject));
projectRouter.post("/create", checkAuth, routeWrapper(projectHandlers.createProject));
projectRouter.patch("/:projectId/edit-title", checkAuth, routeWrapper(projectHandlers.editTitle));
